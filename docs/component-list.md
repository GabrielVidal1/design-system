...
Every component and hook in the library (v0.32.2), with a one-line description of what it is for. Skim this before building UI: if something here already covers the need, use it instead of writing a new component.
